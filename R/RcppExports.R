...
meshed_mcmc <- function(y, family, X, coords, k, binomial_n, parents, children, layer_names, layer_gibbs_group, indexing, set_unif_bounds_in, beta_Vi, lambda_prec, sigmasq_ab, tausq_ab, matern_twonu, start_w, lambda, lambda_mask, theta, beta, tausq, mcmcsd, mcmc_keep = 100L, mcmc_burn = 100L, mcmc_thin = 1L, mcmc_startfrom = 0L, num_threads = 1L, which_hmc = 0L, adapting = FALSE, use_cache = TRUE, use_ps = TRUE, verbose = FALSE, debug = FALSE, print_every = FALSE, sample_beta = TRUE, sample_tausq = TRUE, sample_lambda = TRUE, sample_theta = TRUE, sample_w = TRUE) {
...
rmeshedgp_internal <- function(coords, parents, children, layer_names, layer_gibbs_group, indexing, matern_twonu, theta, num_threads = 1L, use_cache = TRUE, verbose = FALSE, debug = FALSE) {
